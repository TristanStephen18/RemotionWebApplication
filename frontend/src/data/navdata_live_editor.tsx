...
export const CurveLineTrendNave = [
  { key: "general", label: "General", icon: <HomeFilledIcon /> },
  { key: "animation", label: "Animarion & Timing", icon: <AnimationIcon /> },
  { key: "data", label: "Data", icon: <DataArrayIcon /> },
  { key: "theme", label: "Appearance & Theme", icon: <DarkModeIcon /> },
  { key: "flags", label: "Flags", icon: <FlagIcon /> },
  { key: "axis", label: "Axis Settings", icon: <ClearIcon /> },
  { key: "symbols", label: "Floating Symbols", icon: <CurrencyBitcoinIcon /> },
