...
const KB = [
  { zoomStart: 1.0, zoomEnd: 1.18, panX: 60,  panY: -40 },
  { zoomStart: 1.18, zoomEnd: 1.0, panX: -70, panY: 30 },
  { zoomStart: 1.0, zoomEnd: 1.15, panX: -50, panY: -60 },
  { zoomStart: 1.15, zoomEnd: 1.0, panX: 70,  panY: 50 },
  { zoomStart: 1.0, zoomEnd: 1.2, panX: -90, panY: 20 },
] as const;

type KBConf = (typeof KB)[number];
...
export const KenBurnsCarousel2: React.FC<KenBurnsCarouselProps> = ({
  images,
  cardWidthRatio = 0.75,
  ...
  const bgCurrentOpacity = interpolate(slideProgress, [0, 1], [1, blurBgOpacity]);
